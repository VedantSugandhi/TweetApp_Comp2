...
//const API_URL = "http://tweetapp-comp3-lb-291759741.us-east-1.elb.amazonaws.com/api/v1.0/tweets/login";
//export const Forgot_URL="http://tweetapp-comp3-lb-291759741.us-east-1.elb.amazonaws.com/api/v1.0/tweets";

const API_URL = "http://localhost:5000/api/v1.0/tweets/login";
